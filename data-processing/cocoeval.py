...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            # stats[4] = _summarize(1, iouThr=.75, areaRng='small', maxDets=self.params.maxDets[2])
            stats[2] = _summarize(1, iouThr=.5, areaRng='medium', maxDets=self.params.maxDets[2])
            # stats[6] = _summarize(1, iouThr=.75, areaRng='medium', maxDets=self.params.maxDets[2])
            ...
            stats[8] = _summarize(2, iouThr=.5, maxDets=self.params.maxDets[2])
            stats[9] = _summarize(3, iouThr=.5, maxDets=self.params.maxDets[2])
            stats[10] = _summarize(4, iouThr=.5, maxDets=self.params.maxDets[2])

            # stats[8] = _summarize(1, iouThr=.75, areaRng='large', maxDets=self.params.maxDets[2])
